  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Cart(Order Details)</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
				<div class="container">
          <p class="caption"><b>Cutomers delivery and payment details.</b></p>
...
<div>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-communication-vpn-key prefix"></i>	
							...
							<label for="cvv_number" class="">Card Security Number</label>								
        ...
        <div class="container">
          <p class="caption"><b>Total Item's with Payment Amount</b></p>
          <div class="divider"></div>
          <!--editableTable-->
...
<?php
    ...
    echo '<li class="collection-item">
        <div class="row">
            <div class="col s7">
                <p class="collections-title"> Total Bill</p>
            </div>
            <div class="col s2">
                <span>&nbsp;</span>
            </div>
