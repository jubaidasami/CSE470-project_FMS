            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      ...
                      <!--<li><h1 class="logo-wrapper"><a href="index.php" class="navbar bg-warning">Food Ordering Management System</a></h1></li>-->
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">You Order Food</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"><b>Order preferred food here.</b></p>
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><div class="input-field col s12"><label>Amount of items</label>';
