  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><b>Customer Details</b></h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Edit customer details here which are required for delivery and contact.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header"><b>Details:</b></h4>
              </div>
<div>
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/details-router.php" novalidate="novalidate"class="col s12">
                      ...
                      <?php 
                        ...
                        <div class="input-field col s6">
                          ...
                          <label for="email" class="">Card Security Number</label>
						  <div class="errorTxt3"></div>
                        </div>
                      </div>';
                        }
